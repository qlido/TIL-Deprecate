...
INSERT INTO MyUser
values (1, 'lee1545', '이순신', '2022/05/04');
INSERT INTO MyUser
values (2, 'lee1502', '이황', '2022/05/01');
INSERT INTO MyUser
values (3, 'lee1536', '이이', '2022/05/02');
INSERT INTO MyUser
values (4, 'lee1397', '세종대왕', '2022/05/03');
INSERT INTO MyUser
values (5, 'shin1504', '신사임당', '2022/05/05');
select *
from MyUser;
--2번 문제
...
values (1, 1, 2, '한산도 대첩(閑山島大捷) 혹은 견내량대첩(見乃梁大捷)은 1592년 8월 14일(선조 25년 음력 7월 8일) 통영 한산도 앞바다에서 조선 수군이 왜군을 크게 무찌른 해전',
        '2022/05/01', null);
insert into MyComment
values (2, 1, 3, '이 전투에서 육전에서 사용하던 포위 섬멸 전술 형태인 학익진을 처음으로 해전에서 펼쳤다.', '2022/05/01', 1);
insert into MyComment
values (3, 3, 2, '이이의 어머니 신사임당', '2022/05/01', null);
insert into MyComment
values (4, 2,1, '가나다라마바사', '2022/05/01', null);
select *
from Mycomment;
--6번 문제
select NAME
...
where P.CONTENT LIKE '%신사임당%'
   or m.USER_NAME LIKE '신사임당';
--9번 문제
select C.NAME,p.POST_SEQ,p.TITLE,MU.USER_NAME,TO_CHAR(p.DATETIME,'YYYY/MM/DD') as 시간,Count(*)
from POST P
